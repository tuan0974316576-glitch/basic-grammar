...
- Student-facing vocab meaning lookup must stay deterministic and fast: cloud teacher live bank -> bundled teacher bank -> curated local supplement -> Hong Kong / culture supplement -> CC-CEDICT reverse offline index. Do not show placeholder meanings or call live Azure / Gemini meaning fallback while students type.
