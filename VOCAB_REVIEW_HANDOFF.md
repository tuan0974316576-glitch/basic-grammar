...
- `MT15 Paper 4`
- Source tag: `mock-unseen-mt15-paper4-reviewed`
- Added 32 reviewed entries, including mobile zoo / raise spirits / bottle up feelings / animal cruelty / Typhoon Haiyan / birth certificate
- Verified with `npm test`, `npm run check:js`, `npm run build:web`, and Battleship sync / dry-run.

Next likely item:

- Paper 3 is complete. Continue with the next missing Paper 4 item, likely `MT17 Paper 4`, or continue remaining Paper 1 items from the review log.
