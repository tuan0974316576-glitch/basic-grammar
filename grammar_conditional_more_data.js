// More conditional drills. Gameplay lives in ui-grammar.js.
(function () {
    const moreQuestions = [
        {
            "id": "conditional_161",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜我不夠高；如果我更高，我就能碰到最上層的架子。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜我房間很嘈；如果我有一個安靜一點的房間，我會溫習得更好。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜我們不住近車站；如果我們住近車站，我們就不用乘的士。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜我們課室沒有冷氣；如果我們課室有冷氣，學生會更舒服。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜他不夠有耐性；如果他更有耐性，他會再解釋一次。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜我沒有你的地址；如果我有你的地址，我會寄邀請卡。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜測驗不容易；如果測驗容易一點，更多學生會完成。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜她不夠自信；如果她更有信心，她會參加演講比賽。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜巴士太擠迫；如果巴士沒有那麼擠迫，我會上車。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜你沒有細心聽；如果你聽得更細心，你會明白指示。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜我弟弟不夠年長；如果他年長一點，他會升上中學。",
        ...
        },
        {
            ...
            "rule": "2",
            "type": "2",
            "chinese": "可惜他們合作不夠好；如果他們有更好的團隊合作，他們會贏更多比賽。",
        ...
        },
        {
            ...
            "correct_tokens": ["If","we","had","booked","the","court","earlier","then",",","we","would","have","played","badminton","."],
            "accepted": [["If","we","had","booked","the","court","earlier",",","we","would","have","played","badminton","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","they","had","left","home","ten","minutes","earlier","then",",","they","would","have","arrived","on","time","."],
            "accepted": [["If","they","had","left","home","ten","minutes","earlier",",","they","would","have","arrived","on","time","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","the","goalkeeper","had","caught","the","ball","then",",","our","team","would","have","won","."],
            "accepted": [["If","the","goalkeeper","had","caught","the","ball",",","our","team","would","have","won","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","she","had","followed","the","recipe","then",",","the","cake","would","have","tasted","better","."],
            "accepted": [["If","she","had","followed","the","recipe",",","the","cake","would","have","tasted","better","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","we","had","taken","a","map","then",",","we","would","not","have","got","lost","."],
            "accepted": [["If","we","had","taken","a","map",",","we","would","not","have","got","lost","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","he","had","charged","his","tablet","then",",","he","would","have","joined","the","online","lesson","."],
            "accepted": [["If","he","had","charged","his","tablet",",","he","would","have","joined","the","online","lesson","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","they","had","worn","sports","shoes","then",",","they","would","have","run","faster","."],
            "accepted": [["If","they","had","worn","sports","shoes",",","they","would","have","run","faster","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","I","had","locked","the","bike","then",",","it","would","not","have","been","stolen","."],
            "accepted": [["If","I","had","locked","the","bike",",","it","would","not","have","been","stolen","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","the","teacher","had","given","clearer","instructions","then",",","the","group","would","have","finished","sooner","."],
            "accepted": [["If","the","teacher","had","given","clearer","instructions",",","the","group","would","have","finished","sooner","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","we","had","remembered","the","tickets","then",",","we","would","have","entered","the","museum","."],
            "accepted": [["If","we","had","remembered","the","tickets",",","we","would","have","entered","the","museum","."]],
        ...
        },
        {
            ...
            "correct_tokens": ["If","he","had","asked","for","directions","then",",","he","would","not","have","gone","to","the","wrong","building","."],
            "accepted": [["If","he","had","asked","for","directions",",","he","would","not","have","gone","to","the","wrong","building","."]],
