...
assert.ok(
  senseBank.lookup("hot on heels").some((entry) => (
    entry.display === "hot on one's heels"
    && entry.meaning === "緊追在後的"
    && entry.source === "mock-unseen-mt7-paper1-reviewed"
  )),
  "placeholder phrase lookup should allow omitted possessives"
);
assert.ok(
  senseBank.lookup("hot on sb's heels").some((entry) => entry.display === "hot on one's heels"),
...
const mt7Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt7-paper1-reviewed");
assert.ok(mt7Paper1Entries.length >= 88, `Expected MT7 Paper 1 reviewed entries, got ${mt7Paper1Entries.length}`);
const mt8Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt8-paper1-reviewed");
assert.ok(mt8Paper1Entries.length >= 63, `Expected MT8 Paper 1 reviewed entries, got ${mt8Paper1Entries.length}`);
const mt9Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt9-paper1-reviewed");
assert.ok(mt9Paper1Entries.length >= 79, `Expected MT9 Paper 1 reviewed entries, got ${mt9Paper1Entries.length}`);
const mt10Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt10-paper1-reviewed");
assert.ok(mt10Paper1Entries.length >= 95, `Expected MT10 Paper 1 reviewed entries, got ${mt10Paper1Entries.length}`);
const mt11Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt11-paper1-reviewed");
...
const mt19Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt19-paper1-reviewed");
assert.ok(mt19Paper1Entries.length >= 70, `Expected MT19 Paper 1 reviewed entries, got ${mt19Paper1Entries.length}`);
const mt21Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt21-paper1-reviewed");
...
const mt28Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt28-paper1-reviewed");
assert.ok(mt28Paper1Entries.length >= 63, `Expected MT28 Paper 1 reviewed entries, got ${mt28Paper1Entries.length}`);
const mt29Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt29-paper1-reviewed");
...
const mt36Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt36-paper1-reviewed");
...
const mt44Paper1Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt44-paper1-reviewed");
assert.ok(mt44Paper1Entries.length >= 69, `Expected MT44 Paper 1 reviewed entries, got ${mt44Paper1Entries.length}`);
...
const mt34Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt34-paper4-reviewed");
assert.ok(mt34Paper4Entries.length >= 34, `Expected MT34 Paper 4 reviewed entries, got ${mt34Paper4Entries.length}`);
const mt36Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt36-paper4-reviewed");
assert.ok(mt36Paper4Entries.length >= 32, `Expected MT36 Paper 4 reviewed entries, got ${mt36Paper4Entries.length}`);
const mt37Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt37-paper4-reviewed");
assert.ok(mt37Paper4Entries.length >= 32, `Expected MT37 Paper 4 reviewed entries, got ${mt37Paper4Entries.length}`);
const mt39Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt39-paper4-reviewed");
assert.ok(mt39Paper4Entries.length >= 37, `Expected MT39 Paper 4 reviewed entries, got ${mt39Paper4Entries.length}`);
const mt40Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt40-paper4-reviewed");
assert.ok(mt40Paper4Entries.length >= 44, `Expected MT40 Paper 4 reviewed entries, got ${mt40Paper4Entries.length}`);
const mt41Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt41-paper4-reviewed");
assert.ok(mt41Paper4Entries.length >= 35, `Expected MT41 Paper 4 reviewed entries, got ${mt41Paper4Entries.length}`);
const mt43Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt43-paper4-reviewed");
assert.ok(mt43Paper4Entries.length >= 23, `Expected MT43 Paper 4 reviewed entries, got ${mt43Paper4Entries.length}`);
const mt44Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt44-paper4-reviewed");
assert.ok(mt44Paper4Entries.length >= 26, `Expected MT44 Paper 4 reviewed entries, got ${mt44Paper4Entries.length}`);
const mt46Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt46-paper4-reviewed");
assert.ok(mt46Paper4Entries.length >= 23, `Expected MT46 Paper 4 reviewed entries, got ${mt46Paper4Entries.length}`);
const mt47Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt47-paper4-reviewed");
assert.ok(mt47Paper4Entries.length >= 29, `Expected MT47 Paper 4 reviewed entries, got ${mt47Paper4Entries.length}`);
const mt48Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt48-paper4-reviewed");
assert.ok(mt48Paper4Entries.length >= 36, `Expected MT48 Paper 4 reviewed entries, got ${mt48Paper4Entries.length}`);
const mt58Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt58-paper4-reviewed");
assert.ok(mt58Paper4Entries.length >= 26, `Expected MT58 Paper 4 reviewed entries, got ${mt58Paper4Entries.length}`);
const mt61Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt61-paper4-reviewed");
assert.ok(mt61Paper4Entries.length >= 21, `Expected MT61 Paper 4 reviewed entries, got ${mt61Paper4Entries.length}`);
...
const mt18Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt18-paper4-reviewed");
assert.ok(mt18Paper4Entries.length >= 33, `Expected MT18 Paper 4 reviewed entries, got ${mt18Paper4Entries.length}`);
const mt19Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt19-paper4-reviewed");
assert.ok(mt19Paper4Entries.length >= 28, `Expected MT19 Paper 4 reviewed entries, got ${mt19Paper4Entries.length}`);
const mt21Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt21-paper4-reviewed");
assert.ok(mt21Paper4Entries.length >= 29, `Expected MT21 Paper 4 reviewed entries, got ${mt21Paper4Entries.length}`);
const mt23Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt23-paper4-reviewed");
...
const mt28Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt28-paper4-reviewed");
assert.ok(mt28Paper4Entries.length >= 22, `Expected MT28 Paper 4 reviewed entries, got ${mt28Paper4Entries.length}`);
const mt29Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt29-paper4-reviewed");
assert.ok(mt29Paper4Entries.length >= 25, `Expected MT29 Paper 4 reviewed entries, got ${mt29Paper4Entries.length}`);
const mt31Paper4Entries = senseBank.entries.filter((entry) => entry.source === "mock-unseen-mt31-paper4-reviewed");
assert.ok(mt31Paper4Entries.length >= 23, `Expected MT31 Paper 4 reviewed entries, got ${mt31Paper4Entries.length}`);
