...
assert.strictEqual(helpers.normalizeAudioText("vary from... to ..."), "vary from blank to blank");
assert.strictEqual(helpers.normalizeAudioText("make ... redundant"), "make blank redundant");
assert.strictEqual(helpers.normalizeAudioText("in ...'s regard"), "in one's regard");
